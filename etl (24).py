...
def build_receipt_made_summary(dcr_tab: pd.DataFrame) -> dict:
    ...
    full = Updated/Pending/Bounced-or-Cancelled x (Cleared, Deposited,
    Pending, Bounced, Cxn) — every RECEIPT STATUS group and every Status
    column together in one table, used for the "Receipt Made Summary"
    export so Pending is never left out.
    """
    status_relabel = {
        "Updated": "UPDATED",
