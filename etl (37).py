...
def build_mail_summary(
    ...
    body = "\n".join([
        ...
        *online_lines,
        f"4. {rtgs_grand['total_count']:,} RTGS Payments got Updated – Auto/Manual split: {FILL_MANUALLY} (not tracked by this pipeline).",
        "",
    ...
    <div style="{body_font}">
      ...
      <div style="{section}">
        ...
        <ol style="margin:0;padding-left:20px;">
          ...
          <li>{rtgs_grand['total_count']:,} RTGS Payments got Updated – Auto/Manual split: {fill} (not tracked by this pipeline).</li>
        </ol>
