...
def build_mail_summary(
    ...
    body = "\n".join([
        ...
        *online_lines,
        f"4. {rtgs_auto_manual['total']:,} RTGS Payments – Pay Mode Auto Receipt / Manual split is given below.",
        *auto_manual_lines,
        "",
...
def build_mail_html_summary(
    ...
    auto_manual_box = f"""
        <div style="border:1px solid #e2e8f0;border-radius:8px;padding:14px 16px;margin-top:10px;background:#f8fafc;max-width:360px;">
    ...
    <div style="{body_font}">
      ...
      <div style="{section}">
        ...
        <ol style="margin:0;padding-left:20px;">
          ...
          <li>{rtgs_auto_manual['total']:,} RTGS Payments &mdash; Pay Mode Auto Receipt / Manual split is given below.</li>
        </ol>
        {auto_manual_box}
