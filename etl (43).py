        ...
        <table cellpadding="0" cellspacing="0" style="margin-top:12px;">
          <tr>
            <td style="padding-right:20px;vertical-align:top;">
              {img_tag(receipt_made_cid, "Receipt Made Report", pair_w)}
              <div style="font-size:11px;color:#6b7280;margin-top:4px;">Receipt Made Report</div>
            </td>
