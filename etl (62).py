...
def brs_status_image_bytes_v2(result: dict) -> io.BytesIO:
    ...
    for label, cnt in tally_rows:
        ...
        # Label
        draw.text((pad + 74, y + card_h // 2), label,
                  font=_img_font(18), fill=ink, anchor="lm")

        # Count
        draw.text((pad + left_w - 168, y + card_h // 2),
                  f"{cnt:,}", font=_img_font(23), fill=navy, anchor="lm")

        # % pill
        pw = 84
        pill_x = pad + left_w - 92
        ...
        draw.text((pill_x + pw // 2, y + card_h // 2), pct_val,
                  font=_img_font(15), fill="white", anchor="mm")
